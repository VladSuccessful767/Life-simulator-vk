...
const problems = [

    {
        id: "glow_plugs",
        category: "engine",
        title: "Плохой запуск дизельного двигателя",
        engineTypes: ["I3D", "I4D", "I5D", "I6D", "V6D", "V8D"],

        complaints: [
            "На холодную двигатель долго заводится.",
            "После ночной стоянки дизель заводится с трудом.",
            "На холодную двигатель работает неровно первые минуты."
        ],

        causes: [
            { id: "glow_plug", name: "🔥 Неисправны свечи накаливания", probability: 0.55 },
            { id: "glow_relay", name: "⚡ Неисправно реле свечей накаливания", probability: 0.20 },
            { id: "battery", name: "🔋 Слабый аккумулятор", probability: 0.15 },
            { id: "fuel", name: "⛽ Проблема с подачей топлива", probability: 0.10 }
        ],

        checks: {
            visual: {
                name: "👀 Визуальный осмотр дизельной системы", time: 5, equipment: 0,
                results: {
                    glow_plug: "Явных внешних повреждений нет. Нужна проверка системы предпускового подогрева.",
                    glow_relay: "Разъёмы визуально целы. Требуется электрическая проверка.",
                    battery: "Внешних повреждений аккумулятора не обнаружено.",
                    fuel: "Следов утечки топлива не видно."
                }
            },
            glow: {
                name: "🔥 Проверить свечи накаливания", time: 15, equipment: 2,
                results: {
                    glow_plug: "Одна или несколько свечей накаливания имеют повышенное сопротивление/не работают.",
                    glow_relay: "Свечи накаливания исправны.",
                    battery: "Свечи накаливания работают штатно.",
                    fuel: "Свечи накаливания работают штатно."
                }
            },
            relay: {
                name: "⚡ Проверить реле накала", time: 10, equipment: 2,
                results: {
                    glow_plug: "Реле подаёт питание на систему накала.",
                    glow_relay: "Питание на свечи накаливания подаётся неправильно.",
                    battery: "Реле работает штатно.",
                    fuel: "Реле работает штатно."
                }
            },
            battery: {
                name: "🔋 Проверить аккумулятор", time: 5, equipment: 1,
                results: {
                    glow_plug: "Аккумулятор в норме.",
                    glow_relay: "Напряжение аккумулятора в норме.",
                    battery: "При запуске напряжение заметно проседает.",
                    fuel: "Аккумулятор работает в штатном режиме."
                }
            },
            obd: {
                name: "💻 Сканирование OBD", time: 10, equipment: 2,
                results: {
                    glow_plug: "Обнаружена ошибка, связанная с системой свечей накаливания.",
                    glow_relay: "Обнаружена ошибка цепи управления предпусковым подогревом.",
                    battery: "Критических кодов по системе запуска нет.",
                    fuel: "Критических кодов по системе накала нет."
                }
            }
        },

        repairs: {
            glow_plug: { name: "Комплект свечей накаливания", partCost: 3600, workCost: 1200, time: 45 },
            glow_relay: { name: "Реле свечей накаливания", partCost: 2800, workCost: 1000, time: 35 },
            battery: { name: "Аккумулятор", partCost: 6500, workCost: 700, time: 20 },
            fuel: { name: "Топливный фильтр", partCost: 1800, workCost: 900, time: 35 }
        }
    },
...
function generateOrder(){
    ...
    const engines = [
        {type:"I3", title:"Рядный 3-цилиндровый 1.0", mult:0.82, fuel:"petrol"},
        {type:"I4", title:"Рядный 4-цилиндровый 1.6", mult:1.00, fuel:"petrol"},
        {type:"I4T", title:"Рядный 4-цилиндровый 2.0 Turbo", mult:1.12, fuel:"petrol"},
        {type:"I5", title:"Рядный 5-цилиндровый 2.5", mult:1.18, fuel:"petrol"},
        {type:"I6", title:"Рядный 6-цилиндровый 3.0", mult:1.30, fuel:"petrol"},
        {type:"V6", title:"V6 3.0", mult:1.30, fuel:"petrol"},
        {type:"V6T", title:"V6 3.0 Turbo", mult:1.45, fuel:"petrol"},
        {type:"V8", title:"V8 4.4", mult:1.55, fuel:"petrol"},
        {type:"V10", title:"V10 5.2", mult:1.80, fuel:"petrol"},
        {type:"V12", title:"V12 6.0", mult:2.10, fuel:"petrol"},
        {type:"BOXER4", title:"Оппозитный 4-цилиндровый 2.0", mult:1.08, fuel:"petrol"},
        {type:"BOXER6", title:"Оппозитный 6-цилиндровый 3.0", mult:1.35, fuel:"petrol"},
        {type:"VR6", title:"VR6 3.2", mult:1.42, fuel:"petrol"},
        {type:"W12", title:"W12 6.0", mult:2.35, fuel:"petrol"},
        {type:"ROTARY", title:"Роторный Wankel", mult:1.50, fuel:"petrol"},
        {type:"I3D", title:"Рядный 3-цилиндровый 1.5 Diesel", mult:0.95, fuel:"diesel"},
        {type:"I4D", title:"Рядный 4-цилиндровый 2.0 Diesel", mult:1.18, fuel:"diesel"},
        {type:"I5D", title:"Рядный 5-цилиндровый 2.5 Diesel", mult:1.32, fuel:"diesel"},
        {type:"I6D", title:"Рядный 6-цилиндровый 3.0 Diesel", mult:1.45, fuel:"diesel"},
        {type:"V6D", title:"V6 3.0 Diesel", mult:1.48, fuel:"diesel"},
        {type:"V8D", title:"V8 4.4 Diesel", mult:1.72, fuel:"diesel"}
    ];
    let engine = random(engines);
    let availableProblems = problems.filter(p => !p.engineTypes || p.engineTypes.includes(engine.type));
    if(!availableProblems.length) availableProblems = problems;
    do {
        problem = random(availableProblems);
        attempts++;
    } while(problem.id === state.lastProblemId && attempts < 10 && availableProblems.length > 1);
