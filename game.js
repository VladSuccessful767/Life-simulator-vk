...
const knowledgeBase = {
    ...
    engine_types: [
        ["⚙️ Рядный 3-цилиндровый (R3)",
            "Три цилиндра расположены в одном ряду. Двигатель компактный, но из-за меньшего числа цилиндров вибрации и неравномерность работы сильнее зависят от состояния зажигания, смеси и опор. В игре: проверка пропусков, свечей, катушек, подсоса воздуха и наддува у турбоверсий."],

        ["⚙️ Рядный 4-цилиндровый (R4)",
            "Четыре цилиндра расположены в одном ряду. Одна из самых распространённых конструкций. Основные системы: ГБЦ, клапанный механизм, ГРМ, впрыск, зажигание, смазка и охлаждение. В игре это базовый двигатель для обучения диагностике и ремонту."],

        ["⚙️ Рядный 5-цилиндровый (R5)",
            "Пять цилиндров находятся в одном ряду. Конструкция встречается реже R4 и имеет свои особенности балансировки, впрыска и компоновки. При диагностике важно учитывать порядок работы цилиндров и конкретную конструкцию ГРМ."],

        ["⚙️ Рядный 6-цилиндровый (R6)",
            "Шесть цилиндров расположены в одном длинном ряду. Такая схема отличается хорошей равномерностью работы, но двигатель получается длиннее. При ремонте увеличивается количество цилиндров, свечей, форсунок и операций проверки."],

        ["⚙️ V6",
            "Шесть цилиндров расположены двумя рядами по три. У двигателя две стороны и обычно две головки блока. При диагностике пропусков и проблем с ГРМ необходимо учитывать обе группы цилиндров. Некоторые работы требуют больше времени из-за сложной компоновки."],

        ["⚙️ V8",
            "Восемь цилиндров расположены двумя рядами по четыре. В конструкции больше деталей, две группы цилиндров и сложнее выпускная система. В игре стоимость и трудоёмкость ремонта будут выше, а диагностика потребует проверки обеих сторон двигателя."],

        ["⚙️ V10",
            "Десять цилиндров расположены двумя рядами по пять. Редкая и сложная конструкция с большим количеством компонентов. Ошибки зажигания, впрыска и фаз ГРМ требуют более тщательной диагностики и увеличивают время ремонта."],

        ["⚙️ V12",
            "Двенадцать цилиндров — два ряда по шесть. Очень сложная компоновка с большим количеством форсунок, катушек, свечей и элементов ГРМ. В игре это дорогие и длительные работы с высокой ценой ошибки."],

        ["↔️ Оппозитный 4 (Boxer-4)",
            "Четыре цилиндра расположены горизонтально и противоположно друг другу. Двигатель получается низким, а поршни движутся навстречу друг другу. Доступ к деталям и головкам блока отличается от рядных моторов, поэтому некоторые операции требуют работы с обеих сторон."],

        ["↔️ Оппозитный 6 (Boxer-6)",
            "Шесть горизонтально расположенных цилиндров — по три с каждой стороны. Конструкция хорошо сбалансирована, но доступ к отдельным узлам может быть ограничен. В игре диагностика будет учитывать левую и правую стороны двигателя отдельно."],

        ["🔀 VR6",
            "Шесть цилиндров размещены в очень узком V-образном блоке. Это позволяет получить компактную конструкцию при шести цилиндрах. Из-за необычной компоновки ремонт и диагностика требуют знания конкретного двигателя, особенно при работе с ГРМ и ГБЦ."],

        ["🔺 Роторный двигатель Wankel",
            "Вместо обычных поршней используются вращающиеся роторы. Рабочие камеры имеют особую форму, а важную роль играют уплотнения ротора и компрессия. Это принципиально другая конструкция, поэтому в игре для неё будут отдельные процедуры диагностики."],

        ["🛢️ Дизельный двигатель",
            "Дизель работает за счёт воспламенения топлива от высокой температуры сжатого воздуха. Особое значение имеют форсунки, топливный насос высокого давления, свечи накаливания, компрессия и турбина. Типичные задачи: трудный запуск, дымность, коррекции форсунок и недостаточное давление топлива."],

        ["🌪️ Турбированный двигатель",
            "Турбокомпрессор использует энергию выхлопных газов для подачи большего количества воздуха в двигатель. Дополнительные узлы: турбина, интеркулер, патрубки, клапаны и управление наддувом. В игре появятся проверки давления наддува, утечек и управления турбиной."],

        ["🔋 Гибридная силовая установка",
            "Гибрид объединяет ДВС и электрическую часть. Помимо обычного двигателя появляются высоковольтная батарея, инвертор, электромотор и отдельные контуры управления и охлаждения. Такие автомобили потребуют специальной диагностики электронных блоков."],

        ["⚡ Электромотор",
            "В электромобиле нет цилиндров, свечей, форсунок и обычного ГРМ. Основные узлы — высоковольтная батарея, инвертор, электромотор, редуктор и система охлаждения. В игре диагностика будет строиться вокруг электронных блоков, температуры, состояния батареи и электропривода."]
    ]
};
